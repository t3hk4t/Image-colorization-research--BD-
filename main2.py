...
#from modules_core import conv2D_dataloader
from modules_core import conv2D_dataloader_not_loading
...
def main():
    ...
    parser.add_argument('-sequence_name', default=f'radam_relu', type=str)
    ...
    if USE_CUDA:
        MAX_LEN = None
    data_loader_train, data_loader_test = conv2D_dataloader_not_loading.get_data_loaders(args)
                ...
                if tensorboard_image_idx < 100 and data_loader == data_loader_test:
                    for idx in range(x.shape[0]):
                        if tensorboard_image_idx < 100:
                            ...
                            tensorboard_writer.add_image(f'sample_{tensorboard_image_idx}', data, dataformats='HW',
                                                         global_step=epoch)
